...
const NEWS_REGISTRY: NewsItem[] = [
  {
    ...
    summary: 'Санаторий «Пестово» ФТС России полностью подготовил лечебно-парковую инфраструктуру и обновил комплекс климатотерапевтических программ для летнего периода отдыхающих.',
    content: [
      'С наступлением климатического лета Южный берег Крыма расцвел во всем своем великолепии. Рады сообщить, что медицинская служба и парковый департамент ФГКУ Санаторий «Пестово» подошли к старту ключевого летнего сезона во всеоружии.',
  ...
  },
  {
    ...
    content: [
      'Стартовал плановый прием заявлений от региональных таможенных управлений (РТУ) и таможен непосредственного подчинения на распределение санаторно-курортного обеспечения в ФГКУ «Санаторий «Пестово» ФТС России» на II полугодие.',
  ...
  },
  {
    ...
    content: [
      'Благодаря уникальному расположению санатория «Пестово» на стыке лесистых отрогов горы Ай-Петри и теплой черноморской акватории, воздух Гаспры обладает уникальным лечебным составом.',
    ...
    <div className="fixed inset-0 z-[80] overflow-hidden flex items-center justify-center font-sans">
      ...
      >
        ...
        <div className="p-4 bg-stone-100 border-t border-stone-200/80 shrink-0 text-center text-stone-400 font-mono text-[10px] uppercase tracking-wider flex flex-col sm:flex-row justify-between items-center gap-2">
          <span>Служба общественных связей ФГКУ «Санаторий «Пестово» ФТС РФ</span>
