...
const DOCUMENTS_REGISTRY: DocItem[] = [
  {
    id: 'charter',
    title: 'Устав ФГКУ «Санаторий «Пестово» ФТС России»',
...
«Санаторий «Пестово» Федеральной таможенной службы»

1. ОБЩИЕ ПОЛОЖЕНИЯ
1.1. Федеральное государственное казенное учреждение «Санаторий «Пестово» ФТС России» (далее — Учреждение) создано в соответствии с решением Правительства Российской Федерации на базе имущественного комплекса санатория.
...
Выдано на основании решения Лицензирующего органа Министерства Здравоохранения Республики Крым.
Подписано квалифицированной электронной подписью уполномоченного лица.`
  },
  {
    id: 'rules-conduct',
    title: 'Правила внутреннего распорядка и лечебного режима',
    number: 'Регламент № П-4',
    date: '12.01.2024',
    category: 'rules',
    categoryLabel: 'Правила и регламенты',
    summary: 'Регламентирует нормы поведения гостей на территории учреждения, график проведения лечебных программ, правила посещения пляжной и лесопарковой зоны, а также права и обязанности отдыхающих.',
    fullText: `ПРАВИЛА ВНУТРЕННЕГО РАСПОРЯДКА И САНИТАРНОГО РЕЖИМА
В ФГКУ «САНАТОРИЙ «ПЕСТОВО» ФТС РОССИИ»
...
1.2. Стоимость услуг рассчитывается и утверждается согласно официальному прейскуранту ФГКУ «Санаторий «Пестово» ФТС России».
    ...
    <div className="fixed inset-0 z-[80] overflow-hidden flex items-center justify-center font-sans">
      ...
      >
        ...
        <div className="p-4 bg-stone-100 border-t border-stone-200/80 shrink-0 text-center text-stone-400 font-mono text-[10px] uppercase tracking-wider flex flex-col sm:flex-row justify-between items-center gap-2">
          <span>Реестр официальной документации ФГКУ «Санаторий «Пестово»</span>
